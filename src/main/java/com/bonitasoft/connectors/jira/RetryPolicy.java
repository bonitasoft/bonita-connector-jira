...
/**
 * Retry policy with exponential backoff and jitter for JIRA/Confluence API calls.
...
public class RetryPolicy {
     ...
     */
    public <T> T execute(Callable<T> action) throws JiraException {
        int attempt = 0;
        while (true) {
            try {
                return action.call();
                ...
                throw new JiraException("Unexpected error during API call", e);
            }
        }
    }
